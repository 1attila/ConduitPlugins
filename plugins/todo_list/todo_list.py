...
def _display_field(f_name: str, f_data: dict) -> text.Text:
    ...
    if "priority" in f_data:
        ...
        msg += text.aqua(", priority: ") + PRIORITY[priority]
    ...
    if "status" in f_data:
        ...
        msg += text.aqua(", status: ") + STATUS[status]
    ...
    def _update_discord_embed(self):
        ...
        try:
            ...
            try:
                ...
                print("Unable to send the message:", e)
    ...
    def todo(self, ctx: Context, project: Optional[str]=None, completed: plugins.Flag=False):
        ...
        if project is None:
            ...
            if completed is True:
                ...
                msg += text.gray(f"(updated: {self.persistent.update_time})").hover(_relative_time(self.persistent.update_time) + " ago")
                ...
                for c_proj, c_time in self.persistent.completed.items():
                    ...
                    proj_msg += text.gray(c_time).hover(_relative_time(c_time) + " ago")
            ...
            if project not in self.persistent.projects:
                ...
                if completed is True:
                    ...
                    if project not in self.persistent.completed:
                        ...
                        time_msg = text.gray(c_time).hover(_relative_time(c_time) + " ago")
